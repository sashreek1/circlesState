...
def run_gui ():
    ...
    Label(root, text='Enter radius of circle 1 : (cm)', font=26).place(x=20,y=50)
    rad1 = Entry(root,width=10)
    rad1.place(x=260,y=50)
    Label(root, text='Enter radius of circle 2 : (cm)', font=26).place(x=20, y=100)
    rad2 = Entry(root, width=10)
    rad2.place(x=260, y=100)
    Label(root, text='Enter distance between the 2 circles : (cm)', font=26).place(x=20, y=150)
    dist = Entry(root, width=10)
    dist.place(x=370, y=150)
    u = Button(root, text="Submit", command=lambda: task(int(int(rad1.get())*37.7952755906), int(int(rad2.get())*37.7952755906), int(int(dist.get())*37.7952755906)))
    u.place(x=200, y=200)
